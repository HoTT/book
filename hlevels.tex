...
\begin{equation*}
\mathsf{conn}_\modal(f):=\prd{b:B}\mathsf{isContr}(\modal\mathsf{hFiber}(f,b)). 
\end{equation*}
...
is to show that
\begin{equation*}
\prd{b:B}(\pairr{a,p}:\mathsf{hFiber}(g,b)),\ \psi(\varphi(\pairr{a,p}))= \pairr{a,p},
\end{equation*}
...
\begin{align*}
\prd{b:B} P(b) & \simeq \prd{b:B} \modal\mathsf{hFiber}(f,b)\to P(b)\\
& \simeq \prd{b:B} \mathsf{hFiber}(f,b)\to P(b)\\
...
\end{equation*}
we obtain from the assumed equivalence a term $c$ of type $\prd{b:B} \modal\mathsf{hFiber}(f,b)$ with
...
\begin{equation*}
\prd{b:B}(w:\modal\mathsf{hFiber}(f,b)),\ w= c(b).
\end{equation*}
...
\begin{equation*}
\varphi:\big(\prd{b:B}\mathsf{hFiber}(g,b)\big)\to\big(\prd{a:A} \mathsf{hFiber}(g,f(a))\big)
\end{equation*}
defined by $\varphi(s):=s\circ f$ is an equivalence.
\end{cor}
...
transformation
\begin{equation*}
\lambda b.\eta^{\mathsf{hFiber}(f,b)}:\prd{b:B} \mathsf{hFiber}(f,b)\to\modal\mathsf{hFiber}(f,b).
\end{equation*}
...
\begin{equation*}
\prd{b:B} \mathsf{hFiber}(h_1,b)\to\mathsf{hFiber}(h_2,b).
\end{equation*}
