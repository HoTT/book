...
%% BEGIN ERRATA
  ...
  & merge of 50542fe
  & In the definition of $\add$ written with the recursor $\rec{\nat}$, for the function used as $c_s$, $n$ and $m$ should be swapped to match the notation given for the preceding definition of $c_s$ for natural numbers.
  %
  \cref{sec:pat}
  & 111-g1e868fa
