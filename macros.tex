...
\let\reflect\modal
\newcommand{\modaltype}{\ensuremath{\mathsf{Type}_\modal}}
...
% Subuniverse
\renewcommand{\P}{\ensuremath{\mathsf{Type}_{P}}\xspace}
...
\newcommand{\RC}{\ensuremath{\mathbb{R}_\mathsf{c}}\xspace} % Cauchy reals
\newcommand{\RD}{\ensuremath{\mathbb{R}_\mathsf{d}}\xspace} % Dedekind reals
