\appchapter{The rules of type theory}
\label{cha:rules}
...
The goal of this book has been to develop an informal style of mathematics with
a formal basis in homotopy type theory. In this appendix, we offer two precise
formulations of the formal system of homotopy type theory.
The first
...
\and
  ...
  {\oftp{\Gm,\tmtp x\emptyt}{C}{\UU_i} \\ \oftp\Gm{a}{\emptyt}}
...
\and
  ...
  {\premise \\\\ \oftp\Gm{n}{\N}}
  {\Gm\vdash \ind{\N}(x.C,c_0,x.y.c_s,\suc(n))
...
\begin{mathparpagebreakable}
  ...
  {\oftp\Gm{f}{\tprd{x:A} B} \\
   \oftp\Gm{g}{\tprd{x:A} B}}
  {\oftp\Gm{\isequivhapply(f,g)}{\isequiv(\happly_{f,g})}}
\end{mathparpagebreakable}
...
\begin{mathparpagebreakable}
  ...
  {\oftp\Gm{A}{\UU_i} \\
   \oftp\Gm{B}{\UU_i}}
  {\oftp\Gm{\isequividtoeqv(A,B)}{\isequiv(\idtoeqv_{A,B})}}
\end{mathparpagebreakable}
