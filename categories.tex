...
\begin{eg}\label{ct:chaotic}
  Let $X$ be a type and $x_0:X$ an element, and let $X_{\mathrm{ch}}$ denote the \emph{chaotic}\indexdef{chaotic!precategory}\indexdef{chaotic precategory} or \emph{indiscrete}\indexdef{indiscrete!precategory}\indexdef{indiscrete precategory} precategory on $X$.
...
\begin{eg}\label{ct:hilb}
  ...
  \begin{itemize}
  \item Its objects are finite-dimensional \index{finite!-dimensional vector space} vector spaces\index{vector!space} equipped with an inner product $\langle -,-\rangle$.
...
\begin{eg}\label{ct:rezk-fundgpd-trunc1}
  ...
  \indexsee{groupoid!fundamental}{fundamental groupoid}%
