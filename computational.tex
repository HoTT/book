...
We will see in later chapters that this axiom follows both from univalence (see \autoref{sec:compute-universe} and Appendix~\ref{cha:univalence}) and from an interval type (see \autoref{sec:interval}).
