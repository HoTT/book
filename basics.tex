...
A similar problem arises in set-theoretic mathematics, although it manifests slightly differently because set theory cannot actually \emph{construct} anything in the sense that type theory does, only show that things exist.
