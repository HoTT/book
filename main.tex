...
\begin{document}
\newcommand{\ourtitleA}{{Homotopy Type Theory}}
\newcommand{\ourtitleB}{{Univalent Foundations of Mathematics}}
\newcommand{\ourtitle}{{\ourtitleA: \ourtitleB}}
\newcommand{\ourauthorA}{{The Univalent Foundations Program}}
\newcommand{\ourauthorB}{{Institute for Advanced Study}}
\newcommand{\ourauthorC}{{2012-13}}
\newcommand{\ourauthorBC}{{\ourauthorB\\ \ourauthorC}}
\newcommand{\ourauthor}{{\ourauthorA, \ourauthorBC}}
\newcommand{\firstpublicationyear}{{2013}}
\title\ourtitle
\author\ourauthor
