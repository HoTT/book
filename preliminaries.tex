...
\begin{ex}\label{ex:singlepath} Similar for based path induction. Note that according to propositions-as-types, the type $\sm{y:A}(a=y)$ can be regarded as "the type of all elements of A which are equal to a", a type-theoretic version of the "singleton subset" $\{a\}$.
\end{ex}
