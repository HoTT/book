...
% automatically noticed and (with current implementation) the type is
% placed in a superscript.  You can even give more than one variable
...
%%% modalities %%%
\newcommand{\modal}{\ensuremath{\bigcirc}}
\newcommand{\modaltype}{\ensuremath{\type_\modal}}
\newcommand{\ismodal}{\ensuremath{\mathsf{ismodal}}}
