...
spaces\index{space!topological}
...
If $f:X\to Y$ is a pointed map of pointed types, then we refer to the fiber $\hfib f {y_0}$ over the basepoint of $Y$ as ``the'' fiber\index{fiber} of $f$.
...
Given a pointed map $f:X\to Y$, it is easy to extend it to a fiber sequence infinite to
