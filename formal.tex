...
The consistency of univalence and HITs could be shown by an appropriate normalization
procedure, but currently the only proof that univalence is consistent is via a
semantic model in Kan complexes due to Voevodsky \cite{klv:ssetmodel}, and the
only proof that HITs are consistent is via a semantic model due to Lumsdaine and
Shulman \cite{ls:hits}.
