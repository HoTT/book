...
As a topological example, consider in the punctured disc $\setof{ (x,y) | 0 < x^2+y^2 < 2 }$ a loop which starts at $(1,0)$ and goes around the hole at $(0,0)$ once before returning back to $(1,0)$.
