...
In \autoref{cha:hlevels} we will make precise the sense in which this ``suffices for all higher levels'', but as an example, we observe that it suffices for the next level up.
...
We will study other types that are not sets in more detail starting in \autoref{cha:hits}.
