...
For the most part, one does not even need to be aware of this possibility, since it largely coincides with the condition that a proof be ``fully rigorous''.
...
It is worth emphasizing that univalent foundations does not \emph{force} the use of constructive or intuitionistic logic.
...
Every mathematician knows that a theorem is more powerful when proven using fewer assumptions, since it applies to more examples; the situation with AC and LEM is no different.
Univalent foundations improves this situation even further, by making AC and LEM even less necessary than they are in classical mathematics.
