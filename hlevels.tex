...
\begin{proof}
Suppose we have a term $H:\sm{a:A} (f=\lambda x.a)$. A proof by path induction on $p:x= y$ reveals that there is a homotopy
\begin{equation*}
...
Now suppose that there is a term of type
\begin{equation*}
