...
$\UU_i$. We usually want to avoid mentioning the level\indexdef{universe level}\indexsee{level}{universe level or $n$-type} $i$ explicitly,
...
\indexdef{$\beta$-reduction}
\indexdef{$\eta$-expansion}
...
This defining equation is the $\beta$-reduction equation for product types.
...
\index{universe!Tarski-style}%
\index{universe!Russell-style}%
