...
\begin{proof}
  ...
  In addition to~\eqref{eq:freudcodeN} and~\eqref{eq:freudcodeS}, we can conclude from the definition that
  \begin{align*}
    \transfib{\code}{\merid(x_1)}
  \end{align*}
  ...
  \;=\;
  c\left(\north,\refl{\merid(x_1) \ct \opp{\merid(x_0)}}\right).
  \]
  By definition, the right-hand side of this equality is
  \begin{multline*}
    \Transfib{\hat{\code}}{\pairpath(\merid(x_1) \ct \opp{\merid(x_0)}, \blank)}{\tproj{2n}{(x_0,\mathsf{rinv}_{\merid(x_0)})}}\\
    = \Transfib{\hat{\code}}{\pairpath(\opp{\merid(x_0)}, \blank)}
    {\\\Transfib{\hat{\code}}{\pairpath(\merid(x_1), \blank)}{\tproj{2n}{(x_0,\mathsf{rinv}_{\merid(x_0)})}}}
\end{multline*}
