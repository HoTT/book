...
The proof in~\cite{Mines/R/R:1988} uses the power set operation, although it can be made predicative by using typically ambiguous universes to
create the illusion of a large power object; see \autoref{subsec:prop-subsets}.
