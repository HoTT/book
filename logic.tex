...
By definition, a \define{retraction} is a function $r : A \to B$ such that there exists a function $s : B \to A$, called its \define{section}, and a homotopy $\epsilon:\prd{y:B} (r(s(y))=y)$; then we say that $B$ is a \define{retract} of $A$.
