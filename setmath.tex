...
The rule of separation requires some preliminary considerations.  Recall that $V$ lives in the same universe $\UU'$ as the base universe $\UU$ from which it is built. Thus, a priori, the same is true for the identity types $v=_V w$ for any $v,w:V$.  However, we would like for  
