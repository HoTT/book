...
proofs in proof assistants\index{proof assistant} such as \Coq and \Agda.  Almost all of the proofs
...
The improvement of van Kampen we present now is closely analogous to a similar improvement in classical algebraic topology, where $A$ is equip\-ped with a \emph{set $S$ of basepoints}.\index{basepoint!and van Kampen theorem}
