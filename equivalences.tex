...
\begin{defn}\label{defn:ishae}
  ...
  \indexdef{equivalence!half adjoint}%
  \indexdef{half adjoint equivalence}%
  \indexdef{adjoint!equivalence of types, half}
...
\begin{defn}\label{defn:biinv}
  ...
  \indexdef{function!bi-invertible}%
  \indexdef{bi-invertible function}%
  \indexdef{equivalence!as bi-invertible function}%
...
\begin{defn}[Contractible maps] \label{defn:equivalence}
  ...
  \indexdef{function!contractible}%
  \indexdef{contractible!function}%
  \indexdef{equivalence!as contractible function}%
...
\indexdef{split!surjection}%
\indexdef{surjection!split}%
\indexdef{surjective!function!split}%
...
\indexdef{retract!of a function}
...
\indexdef{transformation!fiberwise}%
\indexdef{function!fiberwise}%
\indexdef{fiberwise!transformation}%
\indexdef{fiberwise!map}%
\indexdef{map!fiberwise}
...
\indexdef{axiom!function extensionality!weak}%
