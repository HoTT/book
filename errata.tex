...
%% BEGIN ERRATA
  ...
  & % merge c395527
  & Extra parentheses around $\fall{y\in x}\exis{z\in V} z\in y$ are needed to make the formula unambiguous. In addition, the big parentheses after $\fall{x\in V}$ are added for clarity.\\
  %
  % Chapter 11
  %
