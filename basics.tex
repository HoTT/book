...
\begin{ex}\label{ex:npaths}
  Define, by induction on $n$, a general notion of \define{$n$-dimensional path}\index{path!n-path@$n$-path} in a type $A$, simultaneously with the type of boundaries for such paths.
\end{ex}
