...
Here we give an example of a higher inductive type.  Other inductively defined
types follow the same general scheme --- it is beyond the scope of this
appendix to cover them all.
...
\begin{mathparpagebreakable}
  ...
  {\oftp\Gm{f}{\tprd{x:A} B} \\
   \oftp\Gm{g}{\tprd{x:A} B}}
  {\oftp\Gm{\happly_{f,g}}{\id f g \to f \htpy g}}
\end{mathparpagebreakable}
...
\begin{mathparpagebreakable}
  ...
  {\oftp\Gm{f}{\tprd{x:A} B} \\
   \oftp\Gm{g}{\tprd{x:A} B}}
  {\oftp\Gm{\isequiv\text{-}\happly_{f,g}}{\isequiv(\id f g, f \htpy g,\happly_{f,g})}}
\end{mathparpagebreakable}
...
\begin{mathparpagebreakable}
  ...
  {\oftp\Gm{A}{\UU_i} \\
   \oftp\Gm{B}{\UU_i}}
  {\oftp\Gm{\idtoeqv\text{-}\isequiv(\UU_i,A,B)}{\isequiv(\id[\UU_i] A B, \eqv A B, \lamu{p : \id[\UU_i] A B} \idtoeqv(\UU_i,A,B,p))}}
\end{mathparpagebreakable}
