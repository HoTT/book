...
\def\OPTcovertitlefont{32}    % Size of title font (no unit, pt assumed)
\def\OPTcovertitleskip{14pt}  % Skip between title and subtitle (with units)
\def\OPTcoversubtitlefont{16} % Size of subtitle font (no unit, pt assumed)
...
\def\OPTbackmargin{2cm}       % Page margin
...
\def\OPTtitlesubtitlefont{13} % Size of subtitle font (no unit, pt assumed)
