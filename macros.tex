...
\newcommand{\sectionNotes}{\section*{Notes\addcontentsline{toc}{section}{Notes}}}
\newcommand{\sectionExercises}[1]{\section*{Exercises\addcontentsline{toc}{section}{Exercises}}}
...
\def\prd#1{\@ifnextchar\bgroup%
  {\mathchoice{\@dprd{#1}}{\@tprd{#1}}{\@tprd{#1}}{\@tprd{#1}}\prd}%
...
\def\sm#1{\@ifnextchar\bgroup%
  {\mathchoice{\@dsm{#1}}{\@tsm{#1}}{\@tsm{#1}}{\@tsm{#1}}\sm}%
