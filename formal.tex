...
\end{align*}
%
$C,d,e$ may contain extra implicit parameters $x_1,\ldots,x_n$ if they were obtained in some non-empty context; therefore, the fully explicit primitive recursion schema is
%
\begin{align*}
