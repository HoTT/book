...
We will see in later chapters that this axiom follows either from univalence (see \S\ref{sec:compute-universe} and Appendix~\ref{cha:univalence}) or from an interval type (see \S\ref{sec:interval}).
