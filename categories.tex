...
The fact that categories satisfying the ``saturation'' or ``univalence'' principle as in \autoref{ct:category} are a good notion of category was apparently first proposed by Hofmann and Streicher~\cite{hs:gpd-typethy}.
It then occurred independently to Voevodsky, Shulman, and perhaps others around the same time several years later, and was formalized by Ahrens and Kapulkin~\cite{aks:rezk}.
