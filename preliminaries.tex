...
\begin{rmk}\label{rmk:introducing-new-concepts}
  ...
  \item 
    ...
    (A uniqueness principle whose conclusion involves propositional equality rather than judgmental equality will be called a \define{propositional uniqueness principle},
    ...
    and is said to hold if it can be proven from the other rules for the type.)
  \end{enumerate}
