...
In intuitionistic and constructive mathematics, this is no longer true, but we can still identify truth values with sets that have \emph{at most one element}.
...
If $P$ is a mere proposition, however, then this cannot happen.
