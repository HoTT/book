...
If $\Gamma, y:A, z:\id[A] a y \vdash C : \UU_m$ and $\Gamma, d:C[a/y,\refl{a}/z]$ then we can introduce a defined constant 
\[
...
\and
  ...
  {\oftp{\Gm,\tmtp y{\tsm{x:A} B}}{C}{\UU_i} \\
   ...
   \oftp\Gm{p}{\tsm{x:A} B}}
  {\oftp\Gm{\ind{\tsm{x:A} B}(y.C,a.b.g,p)}{C[\fst(p)/x,\snd(p)/y]}}
\and
  ...
  {\oftp{\Gm,\tmtp xA}{B}{\UU_i} \\
   ...
   \oftp{\Gm,\tmtp y{\tsm{x:A} B}}{C}{\UU_i} \\
   \oftp{\Gm,\tmtp aA,\tmtp b{B[a/x]}}{g}{C[\tup ab/y]}}
  {\oftp\Gm{\ind{\tsm{x:A} B}(y.C,a.b.g,\tup{a'}{b'})}{C[a'/a,b'/b]}}
\end{mathparpagebreakable}
...
\and
  ...
  {\oftp{\Gm,\tmtp xA,\tmtp yA,\tmtp p{\id[A]xy}}{C}{\UU_i} \\
   \oftp{\Gm,\tmtp zA}{c}{C[z/x,z/y,\refl z/p]} \\
   \oftp\Gm{a}{A} \\ \oftp\Gm{b}{A} \\ \oftp\Gm{p'}{\id[A]ab}}
  {\oftp\Gm{\ind{\idsym_A}(x.y.p.C,z.c,a,b,p)}{C[a/x,b/y,p'/p]}}
\and
  \inferrule*[right=$\idsym$-\comp]
  {\oftp{\Gm,\tmtp xA,\tmtp yA,\tmtp p{\id[A]xy}}{C}{\UU_i} \\
   \oftp{\Gm,\tmtp zA}{c}{C[z/x,z/y,\refl z/p]} \\
   \oftp\Gm{a}{A}}
  {\jdeqtp\Gm{\ind{\idsym_A}(x.y.p.C,z.c,a,a,\refl a)}{c[a/z]}{C[a/x,a/y,\refl a/p]}}
\end{mathparpagebreakable}
