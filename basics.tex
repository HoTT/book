...
\indexdef{horizontal composition}%
...
\begin{defn} \label{def:pointedtype}
  ...
  $(A,a)$ is a type $A:\type$ together with a point $a:A$.
...
\begin{lem}[Dependent map]\label{lem:mapdep}
  ...
  \indexdef{dependent!function!application to a path of}%
...
\begin{defn}
  ...
  \indexdef{function!quasi-inverse of}%
