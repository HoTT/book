...
equivalence
\begin{equation*}
\brck{\hfib{P}X}\to (X\simeq\mathsf{unit}))\simeq(\hfib{P}X\to(X\simeq\mathsf{unit})).
\end{equation*}
...
\end{equation*}
so $\mathsf{im}(P)$ satisfies the same universal property as $\brck{A}$. 
