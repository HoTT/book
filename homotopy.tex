...
\begin{figure}
\par
% BOTH TABLE AND IMAGE FOR COMPARISON (TABLE IS TRANSPOSED IMAGE)
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|}\hline
           & $\Sn^0$ & $\Sn^1$ & $\Sn^{2}$ & $\Sn^{3}$ & $\Sn^{4}$ & $\Sn^{5}$ & $\Sn^{6}$ & $\Sn^{7}$ & $\Sn^{8}$ \\ \hline
$\pi_{1}$  & $0$     & $\Z$    & $0$       & $0$       & $0$       & $0$       & $0$       & $0$       & $0$       \\ \hline
$\pi_{2}$  & $0$     & $0$     & $\Z$      & $0$       & $0$       & $0$       & $0$       & $0$       & $0$       \\ \hline
$\pi_{3}$  & $0$     & $0$     & $\Z$      & $\Z$      & $0$       & $0$       & $0$       & $0$       & $0$       \\ \hline
$\pi_{4}$  & $0$     & $0$     & $\Z_{2}$  & $\Z_{2}$  & $\Z$      & $0$       & $0$       & $0$       & $0$       \\ \hline
$\pi_{5}$  & $0$     & $0$     & $\Z_{2}$  & $\Z_{2}$  & $\Z_{2}$  & $\Z$      & $0$       & $0$       & $0$       \\ \hline
$\pi_{6}$  & $0$     & $0$     & $\Z_{12}$ & $\Z_{12}$ & $\Z_{2}$  & $\Z_{2}$ & $\Z$       & $0$       & $0$       \\ \hline
$\pi_{7}$  & $0$     & $0$     & $\Z_{2}$  & $\Z_{2}$  & $\Z \times \Z_{12}$ & $\Z_{2}$ & $\Z_{2}$ & $\Z$ & $0$ \\ \hline
$\pi_{8}$  & $0$     & $0$     & $\Z_{2}$  & $\Z_{2}$  & $\Z_{2}^{2}$ & $\Z_{24}$ & $\Z_{2}$ & $\Z_{2}$ & $\Z$ \\ \hline
$\pi_{9}$  & $0$     & $0$     & $\Z_{3}$  & $\Z_{3}$  & $\Z_{2}^{2}$ & $\Z_{2}$ & $\Z_{24}$ & $\Z_{2}$ & $\Z_{2}$ \\ \hline
$\pi_{10}$ & $0$     & $0$     & $\Z_{15}$ & $\Z_{15}$ & $\Z_{24} \times \Z_{3}$ & $\Z_{2}$ & $0$ & $\Z_{24}$ & $\Z_{2}$ \\ \hline
$\pi_{11}$ & $0$     & $0$     & $\Z_{2}$  & $\Z_{2}$  & $\Z_{15}$ & $\Z_{2}$ & $\Z$ & $0$ & $\Z_{24}$ \\ \hline
$\pi_{12}$ & $0$     & $0$     & $\Z_{2}^{2}$ & $\Z_{2}^{2}$ & $\Z_{2}$ & $\Z_{30}$ & $\Z_{2}$ & $0$ & $0$ \\ \hline
$\pi_{13}$ & $0$     & $0$     & $\Z_{12} \times \Z_{2}$ & $\Z_{12} \times \Z_{2}$ & $\Z_{2}^{3}$ & $\Z_{2}$ & $\Z_{60}$ & $\Z_{2}$ & $0$ \\ \hline
$\pi_{14}$ & $0$     & $0$     & $\Z_{84} \times \Z_{2}^{2}$ & $\Z_{84} \times \Z_{2}^{2}$ & $\Z_{120} \times \Z_{12} \times \Z_{2}$ & $\Z_{2}^{3}$ & $\Z_{24} \times \Z_{2}$ & $\Z_{120}$ & $\Z_{2}$ \\ \hline
$\pi_{15}$ & $0$     & $0$     & $\Z_{2}^{2}$ & $\Z_{2}^{2}$ & $\Z_{84} \times \Z_{2}^{5}$ & $\Z_{72} \times \Z_{2}$ & $\Z_{2}^{3}$ & $\Z_{2}^{3}$ & $\Z \times \Z_{120}$ \\ \hline
\end{tabular}
\par
...
spheres are stable in a certain range (these are the colored diagonals
in \cref{fig:homotopy-groups-of-spheres}):
