...
%% BEGIN ERRATA
  ...
  %
  \autoref{thm:transport-path}
  & 628-g1bd8602
  & The sentence preceding the theorem suggests that it follows from \autoref{cor:transport-path-prepost,thm:transport-compose}, but actually it requires a separate path induction.\\
  %
  ...
  %
  \autoref{ex:same-recurrence-not-defeq}
  & 622-ga0bd007
  & The two functions should satisfy the same recurrence judgmentally.\\
  %
  \autoref{ex:one-function-two-recurrences}
  & 622-ga0bd007
  ...
  %
  \autoref{lem:hedberg-helper}
  & % merge of 7fe7a394d4832ddceb3a7bcc6c953497271fadb5
  ...
  %
  \autoref{sec:more-formal-identity}
  & 578-ga4b94a5
