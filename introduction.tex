...
The concept of a type as the domain of significance of a propositional function was introduced by Bertrand Russell \cite{Russell:1908},\index{Russell, Bertrand} as a device for blocking the paradoxes in the logical foundations of mathematics  that were under investigation at the time. The next milestone in the development of type theory is the paper by Alonzo Church \cite{Church:1940tu} that connected types with the formal system called $\lambda$-calculus  that Church has developed for dealing with functions. 
%
...
%
Type theory started to accumulate new ideas in the late 1960s. The history of type theory from that time to the present is very rich, complex and remains difficult to understand.  In this book we will try to avoid discussing it leaving this subject for further scholarly study. 
