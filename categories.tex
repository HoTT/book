...
\begin{defn}\label{ct:equiv}
  ...
  \indexdef{equivalence!of categories}%
  \indexdef{equivalence!of precategories}%
...
\begin{defn}
  ...
  \indexdef{split!esssentially surjective functor}%
...
\begin{defn}\label{ct:isocat}
  ...
  \indexdef{isomorphism!of precategories}%
  \indexdef{isomorphism!of categories}%
...
\begin{defn}\label{ct:opposite-category}
  ...
  \indexdef{opposite!of a precategory}%
...
\begin{defn}
  ...
  \index{precategories!product of}%
  \index{product!of precategories}%
...
\begin{defn}
  ...
  \indexdef{.precategory@$\dagger$-precategory}%
...
\begin{defn}\label{ct:unitary}
  ...
  \indexdef{.precategory@$\dagger$-precategory!unitary}%
  \indexdef{unitary .precategory@unitary $\dagger$-precategory}%
...
\begin{defn}
  ...
  \indexdef{.category@$\dagger$-category}%
...
\indexdef{Rezk completion}%
\indexdef{completion!Rezk}%
although there is also an argument (coming from higher topos semantics) for calling it the \define{stack completion}.
\indexdef{completion!stack}%
\indexdef{stack!completion}%
...
\begin{ex}
  ...
  \indexdef{precategory!slice}%
  \indexdef{slice!precategory}%
...
\begin{ex}\label{ct:pre2cat}
  Define a \define{pre-2-category}
  \indexdef{pre-2-category}%
  to consist of the structure formed by precategories, functors, and natural transformations in \autoref{sec:transfors}.
  Similarly, define a \define{pre-bicategory}
  \index{pre-bicategory}%
  by replacing the equalities in \autoref{ct:functor-assoc,ct:units} with natural isomorphisms satisfying analogous coherence conditions.
...
\begin{ex}\label{ex:stack}
  ...
  \item Show that if $A$ is a category, then it is a \emph{stack}
    \index{stack}%
