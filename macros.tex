...
%%% Lambda abstractions without explicitly typed variables.
% Call as \lam{x}{y}{z}.  If there is more than one argument, they *must* be enclosed in braces.
\def\lam#1{{\lambda}#1\@ifnextchar\bgroup{.\,\lam}{.\,}}
%%% and with them.  Call as \lamt{x:A}{y:B}.
\def\lamt#1{{\lambda}\@lamtarg#1\@endlamtarg\@ifnextchar\bgroup{.\,\lamt}{.\,}}
\def\@lamtarg#1:#2\@endlamtarg{\@lamtvar{#2},#1\@endlamtvar}
\def\@lamtvar#1,#2{{#2}^{#1}\@ifnextchar,{.\,{\lambda}\@lamtvar{#1}}{\let\@endlamtvar\relax}}
...
\newcommand{\supp}{\ensuremath{\mathsf{sup}}\xspace}
