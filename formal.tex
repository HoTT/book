...
in this book. These supplement the informal presentation in \autoref{syntax-informally}.
The first emphasizes an underlying \emph{untyped} type theory as basic
...
\subsection{Axioms for homotopy type theory}
...
In order to state the function extensionality and univalence axioms, we begin by
recalling some auxiliary definitions.
