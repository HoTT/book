...
Whether or not two expressions are equal by definition is just a matter of expanding out the definitions; in particular, it is algorithmically\index{algorithm} decidable.
...
\indexdef{type!dependent}%
\indexdef{dependent!type}%
...
\indexdef{type!dependent function}%
...
\indexdef{dependent function!application}%
...
\indexdef{type!of natural numbers}%
\indexdef{natural numbers}%
...
\index{variable}%
(hypotheses) $x$ and $y$ of types $A\to\emptyt$ and $B\to\emptyt$. At this point our partial definition of an element of~\eqref{eq:tautology2} can be written as
