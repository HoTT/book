...
\begin{defn}
  Let $f,g:\prd{x:A} P(x)$ be two sections of a dependent type $P:A\to\type$.
...
Property~\ref{item:be3} for this definition is not too hard to prove either, but it requires identifying the identity types of products and dependent sum types, which we will discuss in \S\ref{sec:computational}.
