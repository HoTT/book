...
\begin{thm}\label{thm:ETCS} Assuming the axiom of choice for sets in the form $\mathsf{AC}$, the category $\set$ is a boolean elementary topos with choice, and thus satisfies Lawvere's axioms for the \emph{Elementary Theory of the Category of Sets}.
 \end{thm}
...
It may seem tautologous as stated, but is not.
