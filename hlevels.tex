...
\begin{defn}\label{def:hlevel}
  ...
  \end{cases}
  \]
  We say that $X$ is an \define{$n$-type}
...
\indexdef{.connected@$\modal$-connected!function}%
...
\indexdef{.truncated@$\modal$-truncated!function}%
...
\begin{ex}\label{ex:acconn}
  ...
  \indexdef{axiom!of choice!$n$-connected}%
  to be the statement
  \begin{quote}
