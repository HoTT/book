...
\autoref{tab:theorems} lists the homotopy-theoretic theorems that have been proven in homotopy type theory, and whether
they have been computer-checked.
%% For the spheres,  two
...
\item 
  Lumsdaine proved the Freudenthal suspension theorem, and formalized it with Licata.
  Lumsdaine, Finster, and Licata proved the Blakers-Massey theorem.

\item 
Licata gave an encode-decode calculation of $\pi_2(\Sn ^2)$, and a
calculation of $\pi_n(\Sn ^n)$ using Freudenthal; using similar
