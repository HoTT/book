%%% FORMATTING OPTIONS FOR A4 SIZE
...
% PAGE FORMAT
%
% These settings are for A4 format
...
% Tweak the margins so the textwidth is the same as in the letter version
%
% The letter margins are:
%
...
%
% and half the difference between 8.5in and 210mm is 2.95mm

\newskip\innermarginskip
\innermarginskip=0.75in
\advance\innermarginskip by -2.95mm
\edef\OPTinnermargin{\the\innermarginskip}

\newskip\outermarginskip
\outermarginskip=1.0in
\advance\outermarginskip by -2.95mm
\edef\OPToutermargin{\the\outermarginskip}
