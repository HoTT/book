...
\begin{ex}\label{ex:judgmental-contractibility}
  Suppose we add to type theory the rule that for any contractible type $A$ and any $x,y:A$, we have $x\jdeq y$.
  Show that this contradicts the univalence axiom.
  \emph{(Hint: use \cref{ex:id-reflection-rule}.)}
\end{ex}
