...
{\centering
{\fontsize{60}{80}\fontseries{b}\selectfont The HoTT Book}\par
\vspace*{0.05\textheight}
{\fontsize{45}{60}\fontshape{it}\selectfont Univalent Foundations}\par
}
\vfill
\hbox{}
...
\noindent
\emph{``The HoTT Book''}
\copyright\ The Univalent Foundations Program, Princeton, 2013
