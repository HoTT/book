...
In fact, he defined the entire hierarchy of $n$-types by induction, as we will do in \autoref{cha:hlevels}.\index{h-level}\index{n-type!definable in type theory}%
