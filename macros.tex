...
\newcommand{\un}{\ensuremath{\mathsf{un}}\xspace} % not needed in symbol index

%%% recursor and induction
\newcommand{\rec}[1]{\mathsf{rec}_{#1}}
\newcommand{\ind}[1]{\mathsf{ind}_{#1}}
\newcommand{\indidtwo}[1]{\ind{=_{#1}}^\textrm{two}} % two-sided (Martin-Lof) induction principle for identity types
\newcommand{\indidone}[1]{\ind{=_{#1}}^\textrm{one}} % one-sided (Paulin-Mohring) induction principle for identity types 
...
%%% XXXX Got up to here in index of symbols
...
%%% 2D transport
\newcommand{\transtwo}[2]{\ensuremath{{#1}_{**}\mathopen{}\left({#2}\right)\mathclose{}}\xspace}
...
\newcommand{\aptwo}[2]{\ensuremath{{#1}\mathopen{}\left({#2}\right)\mathclose{}}\xspace}
...
\newcommand{\cd}[1]{\left|#1\right|} % cardinality of a set
...
\crefrangeformat{appendix}{\S\S#3#1#4--#5#2#6}
\Crefrangeformat{appendix}{Appendices~#3#1#4--#5#2#6}
\crefmultiformat{appendix}{\S\S#2#1#3}{ and~#2#1#3}{, #2#1#3}{ and~#2#1#3}
\Crefmultiformat{appendix}{Appendices~#2#1#3}{ and~#2#1#3}{, #2#1#3}{ and~#2#1#3}
\crefrangemultiformat{appendix}{\S\S#3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}{, #3#1#4--#5#2#6}{ and~#3#1#4--#5#2#6}
