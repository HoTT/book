...
\begin{rmk}\label{rmk:introducing-new-concepts}
  ...
  \item how to use elements of that type.  
    ...
    \indexdef{elimination rule}%
    \indexdef{eliminator}%
    (For example, the function type has one eliminator, function application, and
    for inductive types, such as $\Sigma$-types the elimination rule is the induction principle.)
