...
\item 
Guillaume Brunerie gave the proofs of $\pi_{k<n}(\Sn ^ n)$.  He also
gave the proofs of $\pi_2(\Sn ^2)$ and $\pi_3(\Sn ^2)$, by way of
showing that the total space of the Hopf fibration is $\Sn ^3$.  Dan
Licata later gave encode-decode proofs of $\pi_{k<n}(\Sn ^ n)$ and
