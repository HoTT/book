...
\begin{itemize}
\item 
Michael Shulman gave the calculation of $\pi_1(\Sn^1)$, which is the
...
\item Peter Lumsdaine gave the
  ...
  with the calculation of $\pi_2(\Sn ^2)$ and $\pi_3(\Sn ^3)$ as corollaries.  Dan Licata
...
$\pi_{k<n}(\Sn ^n)$ and $\pi_n(\Sn ^n)$; using similar techniques, he
constructed $K(G,n)$.
...
\item 
Kuen-Bang Hou established the theory of covering spaces and formalized it.
\end{itemize}
