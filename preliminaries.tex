...
\indexsee{eliminator!dependent}{induction principle}%
and recursion the \define{non-dependent eliminator}.
\indexsee{eliminator!non-dependent}{recursion principle}%
...
\indexsee{disjoint union}{coproduct}%
