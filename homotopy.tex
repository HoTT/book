...
We begin with a ``na\"ive'' version of the van Kampen theorem, which is useful but not quite as useful as the classical version.
...
\begin{rmk}\label{rmk:naive}
  ...
  This is the main difference between the ``na\"ive'' van Kampen theorem and the more refined one we will consider in the next subsection.
\end{rmk}
...
If $S\jdeq A$ and $k$ is the identity function, then we will recover the na\"ive van Kampen theorem.
