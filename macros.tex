...
\newcommand{\indid}[1]{\ind{=_{#1}}} % two-sided (Martin-Lof) induction principle for identity types
\newcommand{\indidb}[1]{\ind{=_{#1}}'} % one-sided (Paulin-Mohring) induction principle for identity types 
