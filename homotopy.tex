...
If $A$ and $B$ are moreover pointed with basepoints $a_0$ and $b_0$, we define the \define{kernel} of $f$ to be the following subset of $A$:
\symlabel{kernel}
...
their \define{wedge} $A\vee B$ is defined to be the pushout of $A\xleftarrow{a_0}
