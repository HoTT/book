...
\end{align}
The map~\eqref{eq:set-up} cannot be an equivalence, since then we could reproduce the paradoxes\index{paradox} of Cantorian set theory.
...
\autoref{thm:not-dneg,thm:not-lem} rely in essense on a classical theorem of Hedberg,
