...
are called \emph{homotopy equivalent} if there are maps $f : X \rightarrow Y$ and $g : Y \rightarrow X$
...
that you don't start by defining "an $\infty$-groupoid is~\dots" as one
...
2-morphism, 3-morphisms,~\dots given by the identity type.  We will often
...
\subsubsection{Higher inductive types} To do homotopy theory, we need
  basic spaces, such as circle, sphere, and torus, as well as basic
  constructions, such as suspensions and gluing. These are
