...
\begin{defn}\label{ct:nattrans}
  ...
  \indexdef{transformation!natural}%
...
\index{adjoint!equivalence of (pre)categories}
...
\begin{defn}
  ...
  \indexdef{equivalence!of (pre)categories!weak}%
  \indexdef{weak equivalence!of (pre)categories}%
  \indexdef{functor!weak equivalence}%
