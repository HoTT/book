...
\begin{ex}\label{ex:decidable-choice}
  Suppose $P:\nat\to\type$ is a decidable family (see \autoref{defn:decidable-equality}\ref{item:decidable-equality2}) of mere propositions.
  Prove that
  \[ \Brck{\sm{n:\nat} P(n)} \;\to\; \sm{n:\nat}P(n).\]
\end{ex}

\begin{ex}\label{ex:decidable-choice-strong}
  Show that the conclusion of \autoref{ex:decidable-choice} is true if $P:\nat\to\type$ is any decidable family.
\end{ex}
