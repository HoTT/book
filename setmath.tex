...
\end{proof}
  Note that the conditions on a category mentioned in the theorem are known as Lawvere's axioms for the \emph{Elementary Theory of the
Category of Sets}; see~\cite{lawvere:etcs-long,Lawvere/Rosenburgh}.
