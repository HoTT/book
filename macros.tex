...
\newcommand{\indidtwo}{\ind{=_A}^{\rm two}} % two-sided (Martin-Lof) induction principle for identity types
\newcommand{\indidone}{\ind{=_A}^{\rm one}} % one-sided (Paulin-Mohring) induction principle for identity types 
