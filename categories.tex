...
\begin{eg}\label{ct:gaunt}
  ...
  Categories of this sort are sometimes called \define{gaunt}.
...
We define an \define{FO-signature}, $\Omega$, to consist of sets $\Omega_0$ and $\Omega_1$ of function symbols, $\omega:\Omega_0$, and relation symbols, $\omega:\Omega_1$, each having an arity $|\omega|$ that is a set.
...
% \item For $\bbU$-small sets $x,y$ and 
% $\alpha:P^\omega x,\;\beta:P^\omega y,\; f:x\to y$, define
%   \[ H^\omega_{\alpha\beta}(f) \defeq \left\{
%          \begin{array}{ll}
...
% \item 
% \begin{enumerate}
% \item For each $\bbU$-small set $x$ define $Px \defeq \Pi_{\omega :|\Omega|}P^\omega x$, and
% \item for $\bbU$-small sets $x,y$ and $\alpha :Px,\; \beta :Py,\; f:x\to y$
% define 
%   \[ H_{\alpha\beta}(f) \defeq \forall_{\omega :|\Omega|}\; H^\omega_{(\alpha\omega)(\beta\omega)}(f).\]
% \end{enumerate}
% }%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{enumerate}
\end{defn}
