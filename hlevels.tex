...
\indexdef{n-connected@$n$-connected!function}%
...
\indexdef{n-connected@$n$-connected!type}%
\indexdef{type!n-connected@$n$-connected}%
 if the unique function $A\to\unit$ is $n$-connected, i.e.\ if $\trunc nA$ is contractible.
\end{defn}
\indexsee{connected function}{n-connected!function@$n$-connected!function}
\indexsee{connected map}{n-connected!function@$n$-connected!function}
\index{connected map}
...
\index{connected maps!closure properties of}%
...
We end by showing that images are stable under pullback.\index{factorization!image}\index{factorization!stability under pullback}%  
