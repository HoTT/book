...
%% BEGIN ERRATA
  ...
  \cref{ct:gaunt}
  & merge of 2d50ad0
  & Stating that every isomorphism is an identity is not very accurate (consider the discrete category on the interval type). A more accurate statement is that every automorphism is an identity arrow.\\
%% END ERRATA
\end{longtable}
