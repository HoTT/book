...
\def\OPTcovertitlefont{45}    % Size of title font (no unit, pt assumed)
\def\OPTcovertitleskip{20pt}  % Skip between title and subtitle (with units)
\def\OPTcoversubtitlefont{23} % Size of subtitle font (no unit, pt assumed)
\def\OPTcoverauthorfont{20}   % Size of author font (no unit, pt assumed)
\def\OPTcoverauthorskip{8pt}  % Skip betewen first and second line of author (with units)

% FORMATTING OF BACK COVER PAGE
\def\OPTbackmargin{3cm}       % Page margin
...
\def\OPTtitletitlefont{35}    % Size of title font (no unit, pt assumed)
\def\OPTtitletitleskip{10pt}  % Skip between title and subtitle (with units)
\def\OPTtitlesubtitlefont{18} % Size of subtitle font (no unit, pt assumed)
