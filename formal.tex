...
simply cannot be shown by normalization arguments; for example, Lumsdaine and Shulman \cite{ls:hits}
show that higher inductive types are logically consistent. 
