...
%function $\psi$ is defined by $\psi(P)\defeq\pairr{(\sm{b:B} P(b)),\proj1}$. Now
...
%$\hfiber{\proj1}{b}\simeq P(b)$ and therefore it follows immediately
...
%that $(e\cdot\proj1)(a)= f(a)$ for each $a:A$. This completes the proof
