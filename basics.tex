...
The central new idea in homotopy type theory is that each type in type
theory has the the structure of an $\infty$-groupoid.  Recall that for
any type $A$, and any $x,y:A$, we have a identity type $\id[A]{x}{y}$,
