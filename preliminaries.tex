...
We can use the universes to represent higher order logic, that is we can quantify over all propositions or over all predicates.
For example we can represent the proposition \emph{for all properties $P : A \to \UU$ if $P(a)$ then $P(b)$} can be represented as
