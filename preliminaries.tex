...
there can be more than one path between two points.
...
\end{tabular}
\end{center}
Clearly, most of the time we are not going to construct explicit representations of proofs, however, it is good to know that we can do it in principle especaally when in doubt. As an exercise we can verify 
