...
The two formulations of the elimination rule for identity types were given, respectively, by Martin-L\"{o}f~\cite{pml-id} and Paulin-Mohring~\cite{cpm-id}.  Their equivalence was proved by \cite{cpm-id}????
