...
of real numbers as understood by mathematical analysis, namely a complete archimedean
ordered field. Completeness can be understood either in the sense of Cauchy or Dedekind.
We shall use Dedekind's construction for our main development, but we we also present in
\autoref{sec:cauchy-reals} an intriguing ``experimental'' construction of Cauchy reals
which uses a form of higher induction-recursion whose status has not been resolved at
present.
