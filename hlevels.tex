...
\[\prod_{X : \Type} \isofhlevel(1) (\isofhlevel(n)(X)) \to \prod_{X : \Type} \isofhlevel (1) (\isofhlevel(n+1)(X)) \]
To show the conclusion of this implication, we need to show that for any type $X$, 
    \[\isofhlevel(1)(\prod_{x, x' : X}\isofhlevel(n)(x = x')).\]
By \autoref{thm:hlevel_prod} it suffices to show that for any $x, x' : X$, we have 
   \[ \isofhlevel(1) (\isofhlevel(n)(x = x')).\]
