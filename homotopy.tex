...
\autoref{tab:theorems} lists the proofs that  have been done, and whether
they have been computer-checked.  For the spheres,  two
...
\begin{itemize}
\item 
Michael Shulman gave the  proof of $\pi_1(\Sn^1)$, which is the
...
\item 
Guillaume Brunerie gave the  calculation of $\pi_{k<n}(\Sn ^ n)$ for the
...
\item Peter Lumsdaine gave the
   construction of the Hopf fibration.  Guillaume Brunerie gave the
   proof that the total space of the Hopf fibration is $\Sn ^3$,
...
\item 
Dan Licata and Guillaume Brunerie gave the  calculation of $\pi_n(\Sn ^n)$, for the
single-loop presentation of the spheres.
...
\item Guillaume Brunerie calculated $\pi_4(\Sn ^3)$.  

\item 
Kuen-Bang Hou did the theory of covering spaces and formalized it.
\end{itemize}
