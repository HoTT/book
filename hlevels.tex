...
We define $\ismodal A\defeq \mathsf{isEquiv}(\mreturn^\modal_A)$ and $\type_\modal\defeq\sum A:\type, \ismodal A$.
\item for every $A:\type$ and every dependent type $P:\modal(A)\to\type$, a function
\begin{equation*}
R^\modal_A:\big(\prod(a:A),\ \modal(P(\mreturn^\modal_A(a)))\big)\to\prod(z:\modal(A)),\ \modal(P(z)).
\end{equation*}
\item A path $R^\modal_A(f)(\mreturn^\modal_A(a))= f(a)$ for each $f:\prod(a:A),\ \modal(P(\mreturn^\modal_A(a)))$.
...
\begin{equation*}
\prod(z:\modal(A)),\ P(z)\to\prod(a:A),\ P(\mreturn^\modal_A(a))
\end{equation*}
...
\begin{equation*}
\prod(z:\modal(A)),\ s(z)= R^\modal_X(s\circ \mreturn^\modal_A)(z)
\end{equation*}
...
\begin{equation*}
\prod(a:A),\ s(\mreturn^\modal_A(a))= R^\modal_X(s\circ \mreturn^\modal_A)(\mreturn^\modal_A(a)),
\end{equation*}
