...
See also \autoref{subsec:object-classification}.
...
where we deal mostly with sets and mere propositins, it is convenient to define the
traditional logical notation using truncation as follows.

\begin{defn} \label{defn:logical-notation}
  We define \emph{traditional logical notation} using truncation as follows:
  \begin{align*}
    \top            &\ \defeq \ \unit \\
    \bot            &\ \defeq \ \emptyt \\
...
\noindent
Even though this notation makes sense for any types, we shall apply it only to mere
propositions.
