...
\index{univalence axiom}%
The univalence axiom is also due to Voevodsky, although a very similar axiom was proposed by Hofmann and Streicher~\cite{hs:gpd-typethy} under the name ``universe extensionality''.
