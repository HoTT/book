...
\item 
Guillaume Brunerie gave the first calculation of $\pi_{k<n}(\Sn ^ n)$ for the
suspension definition of the spheres. Dan Licata later gave an
encode-decode calculation for the single-loop presentation of the spheres.
...
\item Steve Awodey suggested investigating the Hopf fibration, and that
  ...
  with calculation of $\pi_2(\Sn ^2)$ and $\pi_3(\Sn ^3)$ as corollaries.  Dan Licata
  later gave an encode-decode calculation of $\pi_2(\Sn ^2)$, for the
  single-loop presentation of the spheres.

\item 
Dan Licata and Guillaume Brunerie gave the first calculation of $\pi_n(\Sn ^n)$, for the
single-loop presentation of the spheres.
...
encode-decode calculation of $\pi_2(\Sn ^2)$ and used Freudenthal to calculate
...
\item Guillaume Brunerie calculated $\pi_4(\Sn ^3)$, following a suggestion
...
development of these results.  For example, the first calculation of
$\pi_1(\Sn ^1)$ followed a classical homotopy theoretic one.  A
