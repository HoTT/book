...
Our goal in the rest of the chapter is to make explicit how this higher structure behaves, for particular types defined as in \autoref{cha:typetheory}.
...
We will now state and prove theorems of this sort for all the basic type forming rules.
