...
the wedge $A\vee B$ is defined to be the pushout of $A\stackrel{a_0}{\leftarrow}
\unit\stackrel{b_0}{\rightarrow} B$. 

\begin{lem}
Suppose that $\pairr{A,a_0}$ and $\pairr{B,b_0}$ are $n$- and $m$-connected
pointed types, respectively, with $n,m\geq0$. Then the canonical map $A\vee B\to A\times B$
is $(n+m)$-connected. \note{is this right?}
\end{lem}
