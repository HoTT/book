...
We will first construct a structure of H-space on the circle $\Sn1$, hence by
\autoref{lem:hopf-construction} we will get a fibration over $\Sn2$ with fiber
$\Sn1$ and total space $\Sn1*\Sn1$. We will then prove that this join is
equivalent to $\Sn3$.
