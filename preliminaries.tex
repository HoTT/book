...
\item equalities relating the constructors and eliminators. One kind of equality is \emph{$\beta$-reduction}, which expresses how an   eliminator acts on a constructor.  For example, for functions, the $\beta$-reduction equality states that $(\lamu{x:A}b)(a)$ is equal to the  substitution of $a$ for $x$ in $b$.  Another kind of equality is   \emph{$\eta$-expansion}, which expresses a uniqueness property of constructors or eliminators.  For example, for functions, 
