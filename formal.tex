...
The consistency of Martin-L\"{o}f type theory extended with univalence (respectively
HITs) could in principle be shown by an appropriate normalization procedure, but currently
...
for HITs, a model due to Lumsdaine and Shulman \cite{ls:hits}.
