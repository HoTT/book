...
% \newcommand{\blank}{\mathord{\hspace{1pt}\underline{\hspace{1ex}}\hspace{1pt}}}
...
\newcommand{\footstyle}[1]{{#1}n} % If you index something that is in a footnote
\newcommand{\defstyle}[1]{\textsl{#1}}  % Style for pageref to a definition
