...
\begin{eg}\label{ct:gaunt}
  ...
  This is equivalent to saying that every automorphism in $A$ is an identity arrow; thus it is rather stronger than the classical\index{mathematics!classical} notion of ``skeletal'' category.
